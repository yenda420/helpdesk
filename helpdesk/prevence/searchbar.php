...
//var_dump($table_associative_array); 
...
//$search_keyword = "admin";						// Enter keyword to search
...
function php_search_all_database($search_keyword, $table_associative_array)
{
    ...
    echo "<div class='emptyWrap'><div class='emptyDiv'><p class='empty'><span style='color:black;'>Searched Keyword : </span>" . $search_keyword . '</p></div></div>';
            ...
            foreach ($columnn_name as $column) {
                ...
                if ($db_search_result->num_rows > 0) {
                    while ($row = $db_search_result->fetch_array()) {
                        ...
                        echo '<div class="breaking"><p>Value : <span>' . $row[$column] . "</span></p></div></div>";
